...
window.addEventListener('DOMContentLoaded', () => {
  const mainPageSlider = new _modules_sliders_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.page'
  });
  mainPageSlider.render();
  const modulePageSlider = new _modules_sliders_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.moduleapp'
  });
  ...
  showUpSlider.init();
  const modulesSlider = new _modules_sliders_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
class Difference {
  ...
  bindTriggers() {
    const addElem = (elems, counter) => {
      elems[elems.length - 1].querySelector('.plus').addEventListener('click', () => {
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider */ "./src/js/modules/sliders/slider.js");
...
class SliderMini extends _slider__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(container, slideCSSClass, next, prev, activeClass, animate, autoplay, autoplayInterval) {
    super(container, slideCSSClass, next, prev, activeClass, animate, autoplay, autoplayInterval);
